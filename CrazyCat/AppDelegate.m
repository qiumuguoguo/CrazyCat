...
//	[director setDisplayFPS:YES];
    ...
    //初始化一些设置
    if ([ZZPublic isFirstTimeInstallApplication]) {
        [ZZPublic setIsEnabledSoundEffect:YES];
        CCLOG(@"默认开启音频");
        
        //默认显示广告
        [ZZPublic setIsHiddenAd:NO];
    }
...
- (void)initializePlat
{
     ...
     **/
    [ShareSDK connectSinaWeiboWithAppKey:SHARESDK_APPKEY_SINA
                               appSecret:SHARESDK_APPSECRET_SINA
                             redirectUri:SHARESDK_REDIRECTURI];
     ...
     **/
    [ShareSDK connectWeChatWithAppId:SHARESDK_APPID_WX wechatCls:[WXApi class]];
